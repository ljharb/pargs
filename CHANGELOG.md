...
- [Fix] prefix the `--version` output with `v` [`928157f`](https://github.com/ljharb/pargs/commit/928157f96913a9dd8c132b54137070851b89447a)
...
- [New] add `number` and `integer` option types [`d7e442f`](https://github.com/ljharb/pargs/commit/d7e442fa66412d48d05813bf51e5dfcde2e146b5)
- [Dev Deps] update `@ljharb/eslint-config`, `@types/node`, `eslint`, `npmignore` [`68406d1`](https://github.com/ljharb/pargs/commit/68406d1e08cdc064c9135bbdb120c92183f829f4)
- [readme] replace runkit CI badge with shields.io check-runs badge [`ba954d0`](https://github.com/ljharb/pargs/commit/ba954d07a2c16c5765e3c99a52a1cf82cabd7dd5)
